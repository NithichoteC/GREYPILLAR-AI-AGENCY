...
export const VoidHero: React.FC<VoidHeroProps> = ({ title, description }) => {
  return (
    <div className="h-screen w-full relative bg-[#0A0A0A] flex items-center">
      <div className="absolute inset-0">
        <Scene />
      </div>
      <div className="relative z-20 max-w-6xl mx-auto px-8 flex items-center min-h-screen">
